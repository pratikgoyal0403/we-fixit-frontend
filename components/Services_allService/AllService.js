	...
	return (
		<div className="pb-10 pt-20 md:py-16 lg:py-20">
			<Container responsive="lg">
				<div className="pb-6 sm:pb-0 w-screen-90 sm:w-full overflow-x-auto flex flex-nowrap sm:flex-wrap items-start gap-4 md:gap-6 lg:gap-8 xl:gap-10 sm:justify-center">
